...
export const metadata: Metadata = {
  title: 'Botox in Halstead, from £120 | Visage Aesthetics',
  ...
  openGraph: {
    ...
    description: 'Winner: Best Non-Surgical Aesthetics Clinic 2026, Essex. Nurse-led Botox clinic 12 minutes from Halstead. From £120.',
  ...
  return (
    <GeoLandingTemplate
      ...
      reasons={[
        ...
        { title: 'Closest winner of Best Non-Surgical Aesthetics Clinic 2026, Essex', body: "Best Non-Surgical Aesthetics Clinic 2026, Essex. The closest award-recognised clinic for the Halstead, Earls Colne and Sible Hedingham area." },
      ...
      faqs={[
        ...
        },
        {
          ...
          answer: "The closest Best Non-Surgical Aesthetics Clinic 2026, Essex winner servicing Halstead. Most CO9 residents are within 15 minutes' drive. I am one of the very few aesthetic practitioners in the area with an MSc Advanced Practice (Level 7), the highest postgraduate nursing qualification.",
        },
        {
