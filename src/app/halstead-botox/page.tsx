...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Officially awarded nurse-led Botox clinic 12 minutes from Halstead. From £120.',
  ...
  return (
    <GeoLandingTemplate
      ...
      reasons={[
        ...
        { title: 'Officially awarded in your district', body: "Best Non-Surgical Aesthetics Clinic 2026, Essex. The closest award-recognised clinic for the Halstead, Earls Colne and Sible Hedingham area." },
      ...
      faqs={[
        ...
        },
        {
          ...
          answer: "The closest officially awarded aesthetics clinic to Halstead. Most CO9 residents are within 15 minutes' drive. I am one of the very few aesthetic practitioners in the area with an MSc Advanced Practice (Level 7), the highest postgraduate nursing qualification.",
        },
        {
