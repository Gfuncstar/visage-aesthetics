...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Officially awarded nurse-led lip filler 20 minutes from Sudbury. From £110.',
  ...
  return (
    <GeoLandingTemplate
      ...
      reasons={[
        ...
        { title: 'Officially awarded nurse-led', body: "Best Non-Surgical Aesthetics Clinic 2026, Essex. NMC registered, MSc Advanced Practice (Level 7). Twenty years of clinical experience behind every appointment." },
