      ...
      <section className="bg-cream py-7 md:py-9">
        <div className="max-w-[1100px] mx-auto px-5 md:px-8 text-center">
          <p className="font-display italic text-charcoal mx-auto max-w-3xl" style={{ fontSize: 'clamp(19px, 2vw, 25px)', lineHeight: 1.4, fontWeight: 400 }}>
            Visage Aesthetics is an advanced practice nurse-led aesthetics clinic on Friars Lane, Braintree, Essex, where every treatment is performed by Bernadette Tobin, a registered nurse and prescriber with an MSc in Advanced Practice (NMC PIN 05G1755E) &mdash; the highest postgraduate qualification a UK nurse can hold &mdash; and 20+ years&apos; clinical experience. Awarded Best Non-Surgical Aesthetics Clinic 2026, Essex.
          </p>
        </div>
      </section>
