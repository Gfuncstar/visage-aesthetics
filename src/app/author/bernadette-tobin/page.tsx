...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Winner: Best Non-Surgical Aesthetics Clinic 2026, Essex. Aesthetic nurse, MSc Advanced Practice, NMC PIN 05G1755E. All articles by Bernadette in one place.',
