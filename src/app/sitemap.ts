...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const blogRoutes: MetadataRoute.Sitemap = [
    ...
    'first-time-botox-mistakes',    'anti-wrinkle-aftercare',    'how-long-does-botox-last',    'exercise-and-botox-results',    'vitamin-b12-injections-when-they-work',    'natural-looking-aesthetics-essex',    'hyperhidrosis-botox-explained',
