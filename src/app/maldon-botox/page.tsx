...
export const metadata: Metadata = {
  title: 'Botox in Maldon, from £120 | Visage Aesthetics',
  ...
  openGraph: {
    ...
    description: 'Winner: Best Non-Surgical Aesthetics Clinic 2026, Essex. Nurse-led Botox 25 minutes from Maldon. From £120.',
...
export default function MaldonBotox() {
  return (
    <GeoLandingTemplate
      ...
      positioningLine="Maldon does not have many nurse-led aesthetics clinics. Visage is a 25-minute drive, Best Non-Surgical Aesthetics Clinic 2026, Essex, and the closest Best Non-Surgical Aesthetics Clinic 2026, Essex winner for clients along the Blackwater estuary."
      reasons={[
        { title: 'Closest Best Non-Surgical Aesthetics Clinic 2026, Essex winner', body: "Best Non-Surgical Aesthetics Clinic 2026, Essex. Most Maldon-area aesthetic options are beauty-counter setups; Visage is medically-led with twenty years of clinical experience." },
      ...
      faqs={[
        ...
        },
        {
          ...
          answer: "It is the closest Best Non-Surgical Aesthetics Clinic 2026, Essex winner servicing Maldon. I hold an MSc in Advanced Practice (Level 7), rare in Essex aesthetics. Most local options are Level 4-5 trained or beauty-led. Many Maldon clients drive past several closer clinics to get here for that reason.",
        },
        {
