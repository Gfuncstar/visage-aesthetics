...
const POST = {
  ...
  description: "Anti-wrinkle aftercare: the first 24 hours, written by Bernadette Tobin RGN, MSc Advanced Practice. Winner: Best Non-Surgical Aesthetics Clinic 2026, Essex. Nurse-led clinic in Braintree, Essex.",
