...
const POST = {
  ...
  description: "Botox for excessive sweating: a medical use of an aesthetic treatment, written by Bernadette Tobin RGN, MSc Advanced Practice. Award-winning nurse-led clinic in",
