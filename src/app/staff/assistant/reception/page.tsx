...
import { CalendarClock, CalendarDays, ConciergeBell, FileCheck2, Gift, RotateCcw, Ticket } from 'lucide-react'
...
const cards = [
  ...
  { href: '/staff/assistant/reception/coupon', title: 'Send a coupon', description: 'Email a client a branded discount voucher — set the code and amount.', Icon: Ticket, advanced: true },
  { href: '/staff/assistant/reception/vouchers', title: 'Gift vouchers', description: 'Redeem a gift voucher against the bill — balance kept over visits.', Icon: Gift, advanced: true },
