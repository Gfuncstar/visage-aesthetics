...
export function ConfirmedDot({ status, confirmedAt }: { status: string; confirmedAt: string | null }) {
...
export function ConsentFlag({ name, missing }: { name: string; missing: Set<string> | null }) {
