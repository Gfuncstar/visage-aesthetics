...
export const treatments: Treatment[] = [
  ...
  { name: 'AQUALYX', slug: 'aqualyx', tagline: 'Non-surgical fat dissolving', description: 'Injectable treatment for stubborn localised fat. No surgery, no general anaesthetic, no recovery time.', price: 'Per consultation', href: '/treatments/aqualyx', image: '/images/aqualyx.jpg' },
