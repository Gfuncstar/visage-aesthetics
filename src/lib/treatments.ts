...
export const treatments: Treatment[] = [
  { name: 'Anti-Wrinkle Injections', slug: 'anti-wrinkle-injections', tagline: 'Smooth fine lines naturally', description: "Precisely placed botulinum toxin to soften forehead lines, frown lines and crow's feet. No frozen look.", price: 'From £150', href: '/treatments/anti-wrinkle-injections', image: '/images/anti-wrinkle.jpg' },
  { name: 'Dermal Filler', slug: 'dermal-filler', tagline: 'Restore volume and contour', description: 'Hyaluronic acid filler to restore lost volume, define lips, enhance cheeks or reshape the nose. Immediate, reversible.', price: 'From £200', href: '/treatments/dermal-filler', image: '/images/dermal-filler.jpg' },
  { name: 'Profhilo', slug: 'profhilo', tagline: 'Deep skin bio-remodelling', description: 'High-concentration hyaluronic acid that bio-remodels skin from within. Improves hydration, texture and laxity.', price: 'From £300', href: '/treatments/profhilo', image: '/images/profhilo.jpg' },
  { name: 'HarmonyCa', slug: 'harmonyca', tagline: 'Lift, contour and biostimulate', description: 'A hybrid injectable combining immediate lifting with long-term collagen biostimulation.', price: 'From £450', href: '/treatments/harmonyca', image: '/images/treatment-2.jpg' },
  { name: 'Micro-Needling', slug: 'micro-needling', tagline: 'Rejuvenate from within', description: "Controlled micro-channels stimulate the skin's natural healing response, boosting collagen for smoother, firmer skin.", price: 'From £150', href: '/treatments/micro-needling', image: '/images/micro-needling.jpg' },
